...
#   license-service        output binary name
#   19096        grpcx gRPC listen port
#   18086          optional grpc-gateway listen port
...
WORKDIR /app
COPY --from=builder /out/license-service /app/license-service
...
EXPOSE 19096
EXPOSE 18086
ENTRYPOINT ["/app/license-service"]
